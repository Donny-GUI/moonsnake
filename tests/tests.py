...
import time
import shutil
from transpile.luaparser.ast import parse as lparse, walk as lwalk, Call, Name, If, Assign, Function, Constructor, Initializer
...
def directory_test():
    ...
    ltpt.transpile_directory(f"C:\\Users\\{os.getlogin()}\\Desktop\\decompiled", "decompiled")
