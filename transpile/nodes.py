...
from transpile.luaparser.astnodes import Block, Call, Expression, Name, String, Invoke, Method, Statement, Node, Table
import ast
...
class Initializer(Statement):
    ...
    def __init__(self, source: Expression, name: Name, args: List[Expression], body: Block, **kwargs):
