...
class NodeVisitor(object):
    ...
    cmpops = {"Eq": "==", "NotEq": "!=", "Lt": "<", "LtE": "<=", "Gt": ">",
              ...
              "Mod": "%", "LShift": "<<", "RShift": ">>", "BitOr": "or", "BitXor": "^", 
              "BitAnd": "and", "FloorDiv": "//", "Pow": "**",}
...
class PythonASTWriter(NodeVisitor):
    ...
    def visit_Assign(self, node:ast.Assign) -> str:
        ...
        # x, y, z = a
        elif non_singleton_iterable(node.targets) and (is_singleton(node.value) or isinstance(node.value, list) != True):
    ...
    def visit_Call(self, node:ast.Call):
        ...
        if node.keywords and node.keywords[0] == "GOTO":
            ...
            return
        # super check
        if self._inside_class == True and self._inside_method == True and isinstance(node.func, ast.Attribute) and isinstance(node.func.value, ast.Name):
